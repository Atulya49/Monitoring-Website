          ...
          <div className="flex space-x-4">
            <div className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="URLHitYes" className="text-sm">
                Yes
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="URLHitNo" className="text-sm">
                No
              </label>
            </div>
          </div>
          ...
          <div className="flex space-x-4">
            <div className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="DeadlockYes" className="text-sm">
                Yes
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="DeadlockNo" className="text-sm">
                No
              </label>
            </div>
          </div>
